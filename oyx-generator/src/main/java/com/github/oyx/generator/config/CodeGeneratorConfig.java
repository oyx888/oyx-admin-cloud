package com.github.oyx.generator.config;
...
public class CodeGeneratorConfig {
     ...
     * 基础包   所有的代码都放置在这个包之下
     */
    String packageBase = "com.github.oyx.authority";
    /**
     * 子包名称
     ...
     * 项目统一前缀  比如：  cloud-
     */
    private String projectPrefix = "oyx-";
     ...
     * controller的父类
     */
    private String superControllerClass = "com.github.oyx.base.BaseController";
    /**
     * 表前缀
     */
...
//    private String xmlPath = "";
     ...
     * 驱动连接的URL
     */
    private String url = "jdbc:mysql://127.0.0.1:3306/oyx_core_dev?serverTimezone=CTT&characterEncoding=utf8&useUnicode=true&useSSL=false&autoReconnect=true&zeroDateTimeBehavior=convertToNull";
    /**
     * 驱动名称
     */
    ...
    public static CodeGeneratorConfig build(String serviceName, String childModuleName, String author, String tablePrefix, List<String> tableInclude) {
        ...
        config.setPackageBase("com.github.oyx." + config.getChildModuleName());
        return config;
    }
