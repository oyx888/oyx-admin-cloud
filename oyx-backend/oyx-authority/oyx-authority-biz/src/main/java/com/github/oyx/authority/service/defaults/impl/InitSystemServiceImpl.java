...
import com.github.oyx.authority.dao.defaults.InitDbMapper;
...
public class InitSystemServiceImpl implements InitSystemService {
     ...
     * 需要初始化得库
     */
    private final static List<String> INIT_DATABASE_LIST = Arrays.asList("oyx_base");
