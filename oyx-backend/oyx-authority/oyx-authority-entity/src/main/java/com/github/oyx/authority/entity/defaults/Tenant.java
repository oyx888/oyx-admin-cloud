...
public class Tenant extends Entity<Long> {
    ...
    public Tenant(Long id, LocalDateTime createTime, Long createUser, LocalDateTime updateTime, Long updateUser, 
                    ...
                    String duty, LocalDateTime expirationTime, String logo, String describe, Integer passwordExpire, Boolean isMultipleLogin, 
                    Integer passwordErrorNum, String passwordErrorLockTime) {
        this.id = id;
